...
class Login_system:
    def __init__(self, root):
        ...
        # or_ = Label(login_frame,text="OR", bg="lightgray",font=("times new roman",15,"bold")).place(x=150, y=355)
        #
        ...
        lbl_reg=Label(register_frame,text="Welcome to Inventory Management System",font=("times new roman",13),bg="white").place(x=27,y=20)
