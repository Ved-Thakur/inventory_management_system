...
class salesClass:
    def __init__(self,root):
        ...
        #title
        lbl_title = Label(self.root, text="View Customer Bills", font=("goudy old style", 30), bd=5, relief=RIDGE,
                          bg="#184a45", fg="white").pack(side=TOP, fill=X, padx=10, pady=2)
        ...
        lbl_title2 = Label(bill_Frame, text="Customer BillArea", font=("goudy old style", 30),
